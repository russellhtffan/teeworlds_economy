...
{
    const char *botName = "Potato";
    const char *botClan = "Harvest";
    str_copy(m_aClients[BotNum + 7].m_aName, botName, MAX_NAME_LENGTH);
    str_copy(m_aClients[BotNum + 7].m_aClan, botClan, MAX_CLAN_LENGTH);
